#
#  Be sure to run `pod spec lint Aura.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "daboooo" => "julien.benichou.0@gmail.com" }
  # Or just: s.author    = "daboooo"
  # s.authors            = { "daboooo" => "julien.benichou.0@gmail.com" }
  # s.social_media_url   = "http://twitter.com/daboooo"
  ...
  s.source = { :git => "https://github.com/daboooo/pod.git", :tag => "0.1" }
